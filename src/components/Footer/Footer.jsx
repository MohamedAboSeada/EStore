          ...
          <div className="row">
            <div className="estore__footer col-6 col-md-4 mb-3">
              ...
              <div className="support">
                <p className="support__header">customer support</p>
                <h4 className="support__number text-warning">(926) 555-0129</h4>
              </div>
              <h4 className="support__address text-secondary">
                <i className="fas fa-location-pin"></i>4517 Cairo Eve
              </h4>
