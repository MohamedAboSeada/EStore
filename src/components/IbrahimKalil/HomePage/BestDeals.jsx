          ...
          <tr>
              ...
              <td rowSpan={2} className="dataContainer1">
                <div className="container-fluid py-4">
                  <div style={{ position: "relative" }}>
                    ...
                    <img width={200} height={170} src={product.image} alt="" />
                  </div>
                  ...
                  >
                    ...
                    >
                      <i className="fas fa-cart-shopping"></i>Add to card
                    </button>
                    <button
            ...
            <div className="dataContainer2">
              {products.slice(1, 5).map((product, index) => (
                <td key={index} className="rightDivs container-fluid">
                  <div style={{ position: "relative" }}>
                    {product.label && (
                      <div
                        style={{
                  ...
                  <p style={{ color: "#2DA5F3" }}>{product.actual_price}</p>
                </td>
              ))}
            </div>
          </tr>
      ...
      {products.slice(5,9).map((product, index) => (
        <td key={index} className="rightDivs container-fluid">
          ...
          <div style={{ display: 'flex', gap: '5px' }}>
            {product.oldPrice && <p style={{ textDecoration: 'line-through' }}>{product.discount_price}</p>}
            <p style={{ color: '#2DA5F3' }}>{product.actual_price}</p>
          </div>
        </td>
      ))}
